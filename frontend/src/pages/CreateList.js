...
const CreateList = () => {
    ...
    useEffect(() => {
        ...
        if (!location.state)
        {
            const fetchWIPList = async () => {
                ...
                {
                    // Fetching WIPList
                    const response = await fetch('https://chaoticevents.onrender.com/api/user/'+user.email+'/getWIP', {
                        headers: {
                ...
                else
                {
                    ...
                    const response = await fetch('https://chaoticevents.onrender.com//api/user/setWIP', {
                        method: "POST",
                        body: JSON.stringify({
                            email: user.email,
                            WIPList: newList
    ...
    const handleSaveListClick = async event => {
        ...
        const response = await fetch('https://chaoticevents.onrender.com/api/eventLists', {
                method: 'POST',
