...
const ListView = (userName) => {
    ...
    useEffect(() => {
        ...
        const fetchAuthorProfile = async () => {
            ...
            const response = await fetch(window.$apiURI+'/api/user/getProfile/'+location.state.author, {
                headers: {
    ...
    const fetchUserInteractions = async () => {
        ...
        const response = await fetch(window.$apiURI+'/api/user/interactions/'+user._id, {
            headers: {
    ...
    const handleSaveClick = async event => {
        ...
        try
        {
            const response = await fetch(window.$apiURI+'/api/user/updateInteractions', {
                method: 'PATCH',
