...
const ListView = (userName) => {
    ...
    useEffect(() => {
        ...
        const fetchAuthorProfile = async () => {
            ...
            const response = await fetch('https://daxtonsutherlandworks.com:4000/api/user/getProfile/'+location.state.author, {
                headers: {
    ...
    const fetchUserInteractions = async () => {
        ...
        const response = await fetch('https://daxtonsutherlandworks.com:4000/api/user/interactions/'+user._id, {
            headers: {
    ...
    const handleSaveClick = async event => {
        ...
        try
        {
            const response = await fetch('https://daxtonsutherlandworks.com:4000/api/user/updateInteractions', {
                method: 'PATCH',
