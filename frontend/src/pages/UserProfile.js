...
const UserProfile = () => {
    ...
    useEffect(() => {
        ...
        const fetchUserProfile = async () => {
            const response = await fetch(window.$apiURI+'/api/user/getProfile/'+userName, {
                headers: {
        ...
        const fetchPublicUserEventLists = async () => {
            ...
            const response = await fetch(window.$apiURI+'/api/eventLists/userPublic/'+userName);
    ...
    const handleSaveSnapshotClick = async (event) => {
        ...
        const response = await fetch(window.$apiURI+'/api/user/updateProfile', {
            method: 'PATCH',
    ...
    const handlePopUpButton = async (event) => {
        ...
        if (event.nativeEvent.submitter.id ==="popup-yes") {
            const response = await fetch(window.$apiURI+'/api/user/deleteUser', {
            method: 'DELETE',
